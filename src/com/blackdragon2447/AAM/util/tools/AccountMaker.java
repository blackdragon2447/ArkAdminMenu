package com.blackdragon2447.AAM.util.tools;
...
public class AccountMaker extends JFrame {
	...
	public AccountMaker() {
		...
		JLabel lblNewLabel_2 = new JLabel("SteamID");
		...
		lblNewLabel_3 = new JLabel("Excluded Commands");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String[] commands = textField_3.getText().split(",");
				Integer[] numbers = new Integer[commands.length];
				for(int i = 0;i < commands.length;i++)
				{
				   numbers[i] = Integer.parseInt(commands[i]);
				}
				user.setDisabledCommands(numbers);
