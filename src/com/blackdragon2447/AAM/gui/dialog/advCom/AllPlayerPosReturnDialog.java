...
public class AllPlayerPosReturnDialog extends JFrame {
	 ...
	 */
	public AllPlayerPosReturnDialog() {
		...
		if(!Reference.MultipleServer) {
			try {
				result = RconHandler.command("ListAllPlayerPos");
			} catch (Exception e1) {
			...
			try {
				result = RconHandler.MultipleCommand("ListAllPlayerPos");
			} catch (Exception e1) {
