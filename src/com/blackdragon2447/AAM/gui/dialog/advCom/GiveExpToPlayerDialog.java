	...
	public GiveExpToPlayerDialog() throws UnsupportedLookAndFeelException {
		...
		QueueButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				arguments[2] = "0";
				arguments[3] = ShareWithTribeCheckBox.isSelected() ? "1" : "0";
				
				Reference.Queue.add(new GenericCommand(Utils.getPrefix(), "giveexptoplayer", arguments));
				refreshThread.stop();
				dispose();
			}
		});
	...
	class RefreshThread implements Runnable {
		...
		public void run() {
			...
			while(!exit) {
				...
				System.out.println("-----");
				OutPutLabel.setText(new GenericCommand(Utils.getPrefix(), "giveexptoplayer", arguments).generateCommand());
